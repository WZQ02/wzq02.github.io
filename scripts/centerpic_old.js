...
function centerpic_initialize() {
    ...
    picture.id = "centerpic";
    var screen2 = document.createElement("img");
    screen2.src = "icons/others/screen2_new.svg";
    screen2.id = "toscr2";
    screen2.height = 48;
    screen2.width = 48;
    screen2.onclick = function(){scrolltopage2()};
    var source = document.createElement("source");
    source.srcset = "images/centerpic/front_1.webp";
    source.className = "centerpik";
    source.type = "image/webp";
    var img = document.createElement("img");
    img.src = "images/centerpic/front_1.png";
    img.className = "centerpik";
    img.height = 320;
    img.width = 320;
    img.onclick = function(){onclickchgcenterpic()};
    document.getElementById("centerpic_container").appendChild(picture);
    document.getElementById("centerpic_container").appendChild(screen2);
    document.getElementById("centerpic").appendChild(source);
    document.getElementById("centerpic").appendChild(img);
}
